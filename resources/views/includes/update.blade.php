    ...
    <div x-cloak x-show="modelOpen" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
        ...
        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
            ...
            <div x-cloak x-show="modelOpen" x-transition:enter="transition ease-out duration-300 transform"
                ...
                <form class="mt-5" method="post" action="{{ route('update', $nums['id']) }}"
                    ...
                    @csrf
                     <div>
                        <div class="flex pb-2">
                            ...
                            <input type="text" name="Nom" value="{{$nums->Nom}}"
                        ...
                        <div>
                            ...
                            <input type="text" name="ninterne" value="{{$nums->ninterne}}"
                                class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-red-400 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-40"
                                required>
                        </div>
                        ...
                        <label for="nexterne"
                            ...
                            <input type="text" name="nexterne" value="{{$nums->nexterne}}"
                                class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-red-400 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-40"
                                required>
                        </div>
                        ...
                        <label for="gpinterc"
                            ...
                            <input type="text" name="gpinterc" value="{{$nums->gpinterc}}"
                                class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-red-400 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-40"
                                required>
                        </div>
                        ...
                        <label for="gpdiff"
                            ...
                            <input type="text" name="gpdiff" value="{{$nums->gpdiff}}"
                                class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-red-400 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-40"
                                required>
                        </div>
